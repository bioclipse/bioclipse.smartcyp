...
public class WriteResultsAsHTML {
    ...
    public void writeHead( IMoleculeSet moleculeSet ) {
		...
		outfile.println("border-bottom: 1px solid rgb(200,235,240);");
		outfile.println("background-color: rgb(200,235,240); }");
		...
		outfile.println(".table2c9 {background-color:rgb(200,235,240); border-radius: 5px; padding: 5px}");
    ...
    public void writeBody( IMoleculeSet moleculeSet ) {
		...
		outfile.println("<h1>Results from SMARTCyp version 2.2</h1>");
	...
	public void writeMoleculeKUTable(MoleculeKU moleculeKU) {
		...
		outfile.println("<li id='cyp2C9'><a href=\"javascript:Switch2D6and3A4('2C9')\" title=\"Click to show CYP2C9 predictions\">CYP2C9</a></li>");
		...
		outfile.println("<ul id='navlist'>");
		outfile.println("<li id='cyp3A4'><a href=\"javascript:Switch2D6and3A4('3A4')\" title=\"Click to show standard predictions\">Standard</a></li>");
		outfile.println("<li id='cyp2C9'><a href=\"javascript:Switch2D6and3A4('2C9')\" >CYP2C9</a></li>");
		outfile.println("<li id='cyp2D6'><a href=\"javascript:Switch2D6and3A4('2D6')\" >CYP2D6</a></li>");
		outfile.println("</ul>");
